...
import { useAuth } from "../contexts/AuthContext"; // استدعاء سياق المستخدم
...
export function Profile() {
  // 1. هنا نستدعي بيانات المستخدم المسجل حالياً
    ...
    <div className="min-h-screen bg-gray-50 dir-rtl font-sans pb-12">
      <div className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-5 w-full md:w-auto">
              ...
              <div className="text-right flex-1">
                {/* 2. هذا هو السطر المهم: عرض اسم المستخدم المتغير بدلاً من الاسم الثابت */}
          ...
          {/* بقية محتوى الصفحة (المؤشرات والمواعيد) */}
